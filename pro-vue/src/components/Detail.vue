    ...
    <div id="details">
        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="pro-list">
                    <span class="pro-name"> 类型:<span>{{type}}</span></span>
                    <span class="pro-price">
                        面积:<span>{{area}}</span>
                    </span>
                    <p class="price-sum">所剩套数:<span>{{total}}</span></p>
                </div>
                <!-- 内容区底部按钮 -->
                <div class="button">
                ...
                <div class="pro-policy">
                    <ul>
                        <li>
                            <i class="el-icon-circle-check"></i> 首付最低一万
                        </li>
                        <li>
                            <i class="el-icon-circle-check"></i> 期房现房双重选择
                        </li>
                        <li>
                            <i class="el-icon-circle-check"></i> 月供最底2000
                        </li>
                    </ul>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                this.axios.post('/api/findRoomById', {
                    roomId: this.id
                }).then(response => {
