...
<div class="panel admin-panel">
    <div class="panel-head"><strong><span class="icon-key"></span> 修改所售房型</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/updRoomById.do">
            <%--传递隐藏域--%>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="type" size="50" placeholder="如：两室一厅" value="${room.type}"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="area" size="50" placeholder="如：120平" value="${room.area}"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="total" size="50" placeholder="如：200" value="${room.total}"
